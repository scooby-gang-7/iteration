...
function About()  {
    ...
    return (
        <div>
            ...
            <div>
                <h3>Challenges</h3>
                <p>Wonderpuss' greatest strength was actually our downfall - too much wonder. We envisioned so much functionality: social, functional, visual - an app we would ACTUALLY use.</p>
            </div>
            <div>
                <h3>Stretch Goals</h3>
                <p></p>
