        ...
        <div id='signup-parent'>
            ...
            <form action="#">
                ...
                <div>
                    ...
                    <input type="text" placeholder='first name' name='name_first' value={name_first} onChange={e => setFirstName(e.target.value)} />
                </div>
                <div>
                    <label>Last Name:  </label>
                    <input type="text"  placeholder='last name' name='name_last' value={name_last} onChange={e => setLastName(e.target.value)}/>
                </div>
                <div>
                ...
                <br />
                <button className='' onClick={handleSubmitSignup}>Submit</button>
            </form>
        </div>
    )
}
